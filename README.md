...
![UserStorie1](./user-stories/cap1.jpg)
![UserStorie2](./user-stories/cap2.jpg)
![UserStorie3](./user-stories/cap3.jpg)
![UserStorie4](./user-stories/cap4.jpg)
![UserStorie5](./user-stories/cap5.jpg)
![UserStorie6](./user-stories/cap6.jpg)
![UserStorie7](./user-stories/cap7.jpg)
![UserStorie8](./user-stories/cap8.jpg)
![UserStorie9](./user-stories/cap9.jpg)
![UserStorie10](./user-stories/cap10.jpg)
![UserStorie11](./user-stories/cap11.jpg)
![UserStorie12](./user-stories/cap12.jpg)
...
![Diagrama de panel pacientes postoperatorios](./img-diagram-mockups/diagram1.png)
...
![Diagrama de panel pacientes UCI](./img-diagram-mockups/diagram2.png)
...
![Diagrama  registro nuevos médicos](./img-diagram-mockups/diagram3.png)
...
![Diagrama registro nuevos pacientes](./img-diagram-mockups/diagram4.png)
...
![Diagrama lista de pacientes](./img-diagram-mockups/diagram5.png)
...
![Diagrama agendar una cita en el proyecto](./img-diagram-mockups/diagram6.png)
...
![Diagrama reagendar una cita en el proyecto](./img-diagram-mockups/diagram7.png)
...
![Diagrama visualizar la lista de médicos en el sistema](img-diagram-mockups/diagram8.png)
...
En esta primera iteración, tuvimos como objetivo implementar el diseño de nuestra Landing Page mediante la utilización de Webstorm. Es decir, todas las secciones deben estar terminadas al finalizar el Sprint, ya sea **About**, **Servicios**, **Noticias** o **Contáctanos**.

| **Sprint #** | **Work-Item / Task**  | **Id** | **Title**                           | **Description**                                                | **Estimation (hours)** | **Assigned To** | **Status** |
|--------------|-----------------------|--------|-------------------------------------|----------------------------------------------------------------|------------------------|-----------------|------------|
| 1            | Estructura HTML del Landing Page | 16     | Estructura HTML del Landing Page    | Implementar la estructura básica del landing page usando HTML.  | 6                      | Oscar           | Done       |
| 1            | Estilos CSS del landing page     | 17     | Estilos CSS del landing page        | Aplicar estilos visuales y de diseño al landing page utilizando CSS. | 7                      | Rafael          | Done       |
| 1            | Navegación sección Home landing page | 18     | Navegación sección Home landing page | Implementar la navegación funcional en la sección Home.         | 3                      | Adriana         | Done       |
| 1            | Acceso sobre nosotros            | 12     | Acceso sobre nosotros               | Desarrollar el enlace y la navegación a la sección "Sobre Nosotros". | 4                      | Erick           | Done       |
| 1            | Servicios brindados              | 21     | Servicios brindados                 | Mostrar y estructurar los servicios ofrecidos en la plataforma. | 4                      | Fabio           | Done       |
| 1            | Planes                           | 25     | Planes                              | Integrar una sección para mostrar noticias y actualizaciones recientes. | 5                      | Oscar           | Done       |
| 1            | Noticias                         | 22     | Noticias                            | Crear un formulario y mostrar información de contacto.         | 4                      | Rafael          | Done       |
| 1            | Funcionalidades con JavaScript    | 24     | Funcionalidades con JavaScript      | Implementar funcionalidades interactivas en el sitio mediante JavaScript. | 6                      | Adriana         | Done       |
...
|---------------|----------------------|--------|-----------|---------------------------------------------------------------------------------------------------------------------------------------|------------------------|-----------------|----------------------------------------------------|
| US 29         | Desarrollo de home clinic              | 1      | Desarrollo de home clinic                | Como developer de TukunTech, quiero implementar la sección home clinic para mostrar todas las opciones que hay en la aplicación          | 3                      | Oscar           | Done                                               |
| US 30         | Desarrollo de panel patient postoperative | 2      | Desarrollo de panel patient postoperative | Como developer de TukunTech, quiero implementar la sección panel patient postoperative para visualizar el panel de pacientes postoperatorios y sus signos vitales | 2                      | Oscar           | Done                                               |
| US 31         | Desarrollo de panel UCI patients        | 3      | Desarrollo de panel UCI patients          | Como developer de TukunTech, quiero implementar la sección para visualizar el panel de pacientes UCI y sus signos vitales               | 2                      | Oscar           | Done                                               |
| US 32         | Desarrollo de home registration         | 4      | Desarrollo de home registration           | Como developer de TukunTech, quiero implementar la sección de home registration para mostrar las opciones de registro que tiene la aplicación | 3                      | Adriana         | Done                                               |
| US 33         | Desarrollo de patient registration      | 5      | Desarrollo de patient registration        | Como developer de TukunTech, quiero implementar la sección de patient registration para registrar nuevos pacientes que se vayan a tratar en la clínica | 3                      | Adriana         | Done                                               |
| US 34         | Desarrollo de medical registration      | 6      | Desarrollo de medical registration        | Como developer de TukunTech, quiero implementar la sección de medical registration para registrar nuevo personal médico que se está incorporando a la clínica | 2                      | Adriana         | Done                                               |
| US 35         | Desarrollo list doctors                 | 7      | Desarrollo list doctors                   | Como developer de TukunTech, quiero implementar la sección de list doctors para que se visualice la lista de doctores en la clínica      | 2                      | Oscar           | Done                                               |
| US 36         | Desarrollo list patient                 | 8      | Desarrollo list patient                   | Como developer de TukunTech, quiero implementar la sección list patient para que se visualice la lista de pacientes y sus datos         | 4                      | Oscar           | Done                                               |
| US 40         | Desarrollo de home Appointments         | 9      | Desarrollo de home Appointments           | Como developer de TukunTech, quiero implementar la sección de home Appointments para visualizar y dar acceso a las opciones de citas   |                        | Rafael          | Done                                               |
| US 41         | Desarrollo de Schedule Appointments     | 10     | Desarrollo de Schedule Appointments       | Como developer de TukunTech, quiero implementar la sección de Schedule Appointments para la opción de agendar cita indicando toda la información correspondiente | 3                      | Rafael          | Done                                               |
| US 42         | Desarrollo de Reschedule Appointments   | 11     | Desarrollo de Reschedule Appointments     | Como developer de TukunTech, quiero implementar la sección reschedule appointments para que exista el apartado donde se pueda cambiar datos de una cita ya creada | 3                      | Rafael          | Done                                               |
| US 43         | Desarrollo de home elder                | 12     | Desarrollo de home elder                  | Como developer de TukunTech, quiero implementar la sección de home elder para mostrar todas las secciones que hay en la aplicación      | 2                      | Erick           | Done                                               |
| US 44         | Desarrollo de panel sv elder            | 13     | Desarrollo de panel sv elder              | Como developer de TukunTech, quiero implementar la sección de panel sv elder para que se visualicen los signos vitales del adulto mayor en tiempo real | 1                      | Erick           | Done                                               |
| US 45         | Desarrollo de elder profile             | 14     | Desarrollo de elder profile               | Como developer de TukunTech, quiero implementar la sección de elder profile para que se visualice la información del adulto mayor       | 3                      | Erick           | Done                                               |
...
|------------|----|----------------------------------------|-----------------------------------------------------------------------------------------------------------------|---------------------|-------------|----------|
| US 60      | 1  | Obtener lista de pacientes             | Como Desarrollador, quiero implementar la visualización de la lista de pacientes a través de una API para poder mostrar información completa de pacientes en la interfaz de la aplicación. | 2h                  | Oscar       | Done     |
| US 61      | 2  | Añadir un paciente nuevo               | Como Desarrollador, quiero utilizar la API para añadir pacientes a la aplicación para mostrar la información de nuevos pacientes en el sistema. | 2h                  | Erick       | Done     |
| US 62      | 3  | Obtener datos personales de un paciente| Como Desarrollador, quiero obtener los datos personales de un paciente a través de la API para mostrarlos en la aplicación. | 3h                  | Fabio       | Done     |
| US 63      | 4  | Actualizar datos personales de un paciente | Como Desarrollador, quiero actualizar los datos personales de un paciente a través de la API para reflejar cambios en su información. | 2h                  | Adriana     | Done     |
| US 64      | 5  | Eliminar datos personales de un paciente | Como Desarrollador, quiero eliminar los datos personales de un paciente mediante la API para remover información que ya no es relevante. | 2h                  | Oscar       | Done     |
| US 65      | 6  | Obtener signos vitales de un paciente  | Como Desarrollador, quiero implementar la visualización de los signos vitales de un paciente mediante la API para monitorear sus parámetros de salud en la aplicación. | 2h                  | Erick       | Done     |
| US 66      | 7  | Obtener historial de signos vitales de un paciente por fechas | Como Desarrollador, quiero obtener el historial de signos vitales de un paciente dentro de un rango de fechas a través de la API para mostrar la evolución de sus signos vitales en el tiempo. | 3h                  | Fabio       | Done     |
| US 67      | 8  | Obtener historia clínica de un paciente| Como Desarrollador, quiero obtener la historia clínica de un paciente a través de una API para mostrársela al personal médico. | 2h                  | Adriana     | Done     |
| US 68      | 9  | Nueva entrada en la historia clínica de un paciente | Como Desarrollador, quiero permitir al usuario añadir una nueva entrada en la historia clínica de un paciente a través de una API para registrar información médica relevante. | 3h                  | Oscar       | Done     |
| US 69      | 10 | Actualizar información en la historia clínica de un paciente | Como Desarrollador, quiero permitir al usuario actualizar información específica en la historia clínica de un paciente a través de una API para mantener la información actualizada. | 4h                  | Erick       | Done     |
| US 70      | 11 | Eliminar información en la historia clínica de un paciente | Como Desarrollador, quiero permitir al usuario eliminar información específica en la historia clínica de un paciente a través de una API para gestionar la información de manera eficiente. | 3h                  | Fabio       | Done     |
| US 71      | 12 | Obtener lista de doctores              | Como Desarrollador, quiero implementar la visualización de la lista de doctores a través de una API para mostrar información detallada de cada doctor en la aplicación. | 2h                  | Adriana     | Done     |
| US 72      | 13 | Añadir un doctor nuevo                 | Como Desarrollador, quiero utilizar la API para añadir un nuevo doctor a la aplicación para mostrar su información en el sistema. | 3h                  | Oscar       | Done     |
| US 73      | 14 | Actualizar información de un doctor    | Como Desarrollador, quiero actualizar la información de un doctor a través de la API para reflejar cambios en su perfil. | 4h                  | Erick       | Done     |
| US 74      | 15 | Eliminar un doctor                     | Como Desarrollador, quiero eliminar un doctor mediante un API para remover información que ya no es relevante. | 2h                  | Fabio       | Done     |
| US 75      | 16 | Obtener horarios de doctores           | Como Desarrollador, quiero obtener los horarios de los doctores mediante la API para mostrar la disponibilidad de cada doctor en la aplicación. | 3h                  | Adriana     | Done     |
| US 76      | 17 | Agendar una cita                       | Como Desarrollador, quiero utilizar la API para agendar una cita entre un paciente y un doctor para reflejar la programación de la cita en el sistema. | 2h                  | Oscar       | Done     |
| US 77      | 18 | Reagendar una cita                     | Como Desarrollador, quiero utilizar la API para reagendar una cita existente para que la nueva fecha y hora se reflejen en el sistema. | 3h                  | Erick       | Done     |
| US 78      | 19 | Cancelar una cita                      | Como Desarrollador, quiero permitir al usuario cancelar una cita de un paciente a través de una API para gestionar la agenda de citas. | 2h                  | Fabio       | Done     |
| US 79      | 20 | Obtener datos personales del perfil de un adulto mayor | Como Desarrollador, quiero obtener los datos personales de un adulto mayor a través de una API para mostrar su perfil completo en la aplicación. | 2h                  | Adriana     | Done     |
| US 80      | 21 | Agregar de un adulto mayor             | Como Desarrollador, quiero añadir el perfil de un adulto mayor a través de una API para poder registrar sus datos en el sistema. | 2h                  | Oscar       | Done     |
| US 81      | 22 | Actualizar perfil de un adulto mayor   | Como Desarrollador, quiero actualizar los datos del perfil de un adulto mayor a través de una API para reflejar cambios en su información. | 3h                  | Erick       | Done     |
| US 82      | 23 | Eliminar perfil de un adulto mayor     | Como Desarrollador, quiero eliminar el perfil de un adulto mayor a través de una API para remover información que ya no es relevante. | 2h                  | Fabio       | Done     |
| US 83      | 24 | Obtener signos vitales en tiempo real de un adulto mayor | Como Desarrollador, quiero obtener los signos vitales en tiempo real de un adulto mayor a través de una API para monitorear su salud en la aplicación. | 2h                  | Adriana     | Done     |
| US 84      | 25 | Obtener historia clínica de un adulto mayor | Como Desarrollador, quiero obtener la historia clínica de un adulto mayor a través de una API para mostrársela al personal médico. | 2h                  | Oscar       | Done     |
| US 85      | 26 | Agregar entrada a historia clínica de un adulto mayor | Como Desarrollador, quiero permitir al usuario añadir una nueva entrada en la historia clínica de un adulto mayor a través de una API para registrar información médica relevante. | 3h                  | Erick       | Done     |
| US 86      | 27 | Actualizar información en la historia clínica de un adulto mayor | Como Desarrollador, quiero permitir al usuario actualizar información específica en la historia clínica de un adulto mayor a través de una API para mantener la información actualizada. | 4h                  | Fabio       | Done     |
| US 87      | 28 | Eliminar información en la historia clínica de un adulto mayor | Como Desarrollador, quiero permitir al usuario eliminar información específica en la historia clínica de un adulto mayor a través de una API para gestionar la información de manera eficiente. | 2h                  | Adriana     | Done     |
| US 88      | 29 | Obtener números de emergencia          | Como Desarrollador, quiero obtener los números de emergencia de un adulto mayor a través de una API para mostrarlos al personal médico o familiar. | 2h                  | Oscar       | Done     |
| US 89      | 30 | Agregar número de emergencia           | Como Desarrollador, quiero permitir al usuario agregar un número de emergencia a través de una API para registrar información de contacto importante en caso de emergencia. | 2h                  | Erick       | Done     |
| US 90      | 31 | Actualizar número de emergencia        | Como Desarrollador, quiero permitir al usuario actualizar un número de emergencia a través de una API para mantener la información de contacto de emergencia actualizada. | 2h                  | Fabio       | Done     |
| US 91      | 32 | Eliminar número de emergencia          | Como Desarrollador, quiero permitir al usuario eliminar un número de emergencia a través de una API para gestionar la información de manera eficiente. | 2h                  | Adriana     | Done     |
| US 92      | 33  | Obtener lista de alertas                     | Como Desarrollador, quiero obtener la lista de alertas de un paciente a través de una API para visualizar eventos importantes en su monitoreo de salud.                   | 2h                  | Oscar       | Done   |
| US 93      | 34  | Generar alerta por cambio en signos vitales  | Como Desarrollador, quiero permitir la generación de una alerta automática si los signos vitales de un paciente muestran cambios significativos, utilizando una API.       | 4h                  | Erick       | Done   |
| US 94      | 35  | Obtener alertas de signos vitales históricos | Como Desarrollador, quiero obtener el historial de alertas de signos vitales de un paciente mediante la API para analizar patrones de salud.                              | 3h                  | Fabio       | Done   |
| US 95      | 36  | Enviar alertas a personal médico             | Como Desarrollador, quiero enviar alertas al personal médico a través de una API para que estén informados de cambios críticos en los signos vitales de un paciente.       | 4h                  | Adriana     | Done   |
| US 96      | 37  | Crear perfil de cuidador                     | Como Desarrollador, quiero permitir la creación de un perfil de cuidador mediante la API para que estén vinculados a un adulto mayor en el sistema.                       | 2h                  | Oscar       | Done   |
| US 97      | 38  | Obtener lista de cuidadores                  | Como Desarrollador, quiero obtener la lista de cuidadores asociados a un paciente mediante la API para visualizar información de contacto.                               | 2h                  | Erick       | Done   |
| US 98      | 39  | Vincular cuidador a adulto mayor             | Como Desarrollador, quiero permitir la vinculación de un cuidador a un adulto mayor en el sistema a través de la API.                                                     | 3h                  | Fabio       | Done   |
| US 99      | 40  | Notificar a cuidador sobre alerta            | Como Desarrollador, quiero enviar una notificación a un cuidador cuando ocurra una alerta en los signos vitales del adulto mayor que monitorea.                           | 4h                  | Adriana     | Done   |
| US 100     | 41  | Configurar preferencias de notificación       | Como Desarrollador, quiero permitir que el cuidador configure sus preferencias de notificación a través de la API para recibir alertas según sus preferencias.             | 3h                  | Oscar       | Done   |
| US 101     | 42  | Consultar parámetros de configuración del sistema | Como Desarrollador, quiero permitir la consulta de los parámetros de configuración del sistema a través de la API para mantener la configuración en revisión.              | 2h                  | Erick       | Done   |
...
| **Location**                      | Reunión virtual mediante llamada Discord                                                  |
| **Prepared By**                   | Adriana Palomares                                                                         |
| **Attendees (to planning meeting)** | Rafael Bravo / Fabio Nicolich / Erick Maraza / Oscar Soto / Fabrizio Quiroz               |
| **Sprint 4 – 3 Review Summary**   | Desarrollo WebService.                                                                    |
| **Sprint 4 – 3 Retrospective Summary** | Correcciones de errores en la documentación, correcciones en nomenclatura del backend. |
| **Sprint Goal & User Stories**    |                                                                                           |
| **Sprint 4 Goal**                 | Our focus is on enhancing the platform to provide visitors with more relevant content on the landing page, improving interaction for medical staff and caregivers through a more intuitive web application interface, and establishing a robust infrastructure for developers to manage and process patient data efficiently in real-time.
We believe this will deliver an improved user experience that encourages greater engagement on the landing page, enables medical staff and caregivers to access and manage patient information securely and effectively, and ensures developers can handle data seamlessly. Additionally, the implementation of authentication and verification services will guarantee secure access to critical system functionalities.
This will be confirmed when visitors interact more with the landing page, medical staff and caregivers can efficiently access and manage patient information, and developers can ensure data is stored and processed smoothly and securely.

 |
| **Sprint 4 Velocity**             | 71                                                                                       |
| **Sum of Story Points**           | 71                                                                                       |
...
|---------------|-----------------------------------------------------------|--------------|----------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|---------------------|-------------|----------------|
| 99            | Inicio de sesión de usuario                               | 1            | Inicio de sesión de usuario                       | Como Desarrollador, Quiero implementar la funcionalidad de inicio de sesión en la API, Para que los usuarios puedan autenticar su acceso.    | 5                   | Adriana     | To-do          |
| 100           | Ver Historial de Paciente                                 | 2            | Ver Historial de Paciente                         | Como Desarrollador, Quiero implementar la funcionalidad de ver el historial clínico de un paciente, Para que los usuarios accedan a detalles.| 3                   | Fabio       | To-do          |
| 101           | Listar tipos de sangre                                    | 3            | Listar tipos de sangre                            | Como Desarrollador, Quiero implementar un endpoint para listar todos los tipos de sangre disponibles, Para que se muestren en el sistema.    | 2                   | Rafael      | To-do          |
| 102           | Listar nacionalidades                                     | 4            | Listar nacionalidades                             | Como Desarrollador, Quiero implementar un endpoint para listar todas las nacionalidades, Para que se usen en formularios del sistema.         | 2                   | Erick       | To-do          |
| 103           | Listar géneros                                            | 5            | Listar géneros                                    | Como Desarrollador, Quiero implementar un endpoint para listar todos los géneros disponibles, Para que se usen en formularios.               | 2                   | Oscar       | To-do          |
| 104           | Listar especializaciones médicas                          | 6            | Listar especializaciones médicas                 | Como Desarrollador, Quiero implementar un endpoint para listar especializaciones médicas, Para que se usen en la selección de doctores.      | 2                   | Fabricio    | To-do          |
| 105           | Listar estados de medicamentos pendientes                 | 7            | Listar estados de medicamentos pendientes         | Como Desarrollador, Quiero implementar un endpoint para listar todos los estados de medicamentos, Para que se usen en el flujo de trabajo.   | 2                   | Adriana     | To-do          |
| 106           | Listar tipos de alertas críticas                          | 8            | Listar tipos de alertas críticas                 | Como Desarrollador, Quiero implementar un endpoint para listar tipos de alertas críticas, Para que se clasifiquen adecuadamente.             | 2                   | Fabio       | To-do          |
| 107           | Listar alergias                                           | 9            | Listar alergias                                   | Como Desarrollador, Quiero implementar un endpoint para listar todas las alergias conocidas, Para que se muestren en los registros médicos.  | 2                   | Rafael      | To-do          |
| 108           | Listar aseguradoras médicas                               | 10           | Listar aseguradoras médicas                       | Como Desarrollador, Quiero implementar un endpoint para listar todas las aseguradoras médicas, Para que se usen en el registro.              | 2                   | Erick       | To-do          |
| 109           | Creación de la entidad AuthEntity para autenticación      | 11           | Creación de la entidad AuthEntity para autenticación | Como Desarrollador, Quiero implementar una entidad AuthEntity para los usuarios, Para que puedan ser registrados y autenticados.             | 6                   | Oscar       | To-do          |
| 110           | Creación Auth Guard                                       | 12           | Creación Auth Guard                               | Como Desarrollador, Quiero implementar un guard para la autenticación, Para que proteja rutas del sistema.                                   | 3                   | Fabricio    | To-do          |
| 111           | Creación Auth Interceptor                                 | 13           | Creación Auth Interceptor                         | Como Desarrollador, Quiero implementar un interceptor para agregar el token de autenticación, Para que valide solicitudes al backend.        | 2                   | Adriana     | To-do          |
| 112           | Creación Auth Service                                     | 14           | Creación Auth Service                             | Como Desarrollador, Quiero implementar un servicio de autenticación, Para gestionar inicio de sesión, registro y tokens.                     | 2                   | Fabio       | To-do          |
| 113           | Login                                                     | 15           | Login                                             | Como Desarrollador, Quiero conectar el componente login al backend, Para que los usuarios puedan autenticarse en el sistema.                 | 3                   | Rafael      | To-do          |
| 114           | Crear cuenta                                              | 16           | Crear cuenta                                      | Como Desarrollador, Quiero conectar el componente create-account al backend, Para que los usuarios se registren en el sistema.               | 2                   | Erick       | To-do          |
| 115           | Ver citas                                                 | 17           | Ver citas                                         | Como Desarrollador, Quiero conectar el componente appointments al API service, Para que los usuarios puedan ver sus citas programadas.       | 2                   | Oscar       | To-do          |
| 116           | Reprogramar citas                                         | 18           | Reprogramar citas                                 | Como Desarrollador, Quiero conectar el componente reschedule-appointments al API service, Para reprogramar una cita.                         | 3                   | Fabricio    | To-do          |
| 117           | Agendar nuevas citas                                      | 19           | Agendar nuevas citas                              | Como Desarrollador, Quiero conectar el componente schedule-appointments al API service, Para que los usuarios agenden citas.                 | 3                   | Adriana     | To-do          |
| 118           | Ver perfil Adultos mayores                                | 20           | Ver perfil Adultos mayores                       | Como Desarrollador, Quiero conectar el componente elder-profile al API service, Para ver información de adultos mayores.                     | 2                   | Fabio       | To-do          |
| 119           | Ver lista de medicinas pendientes                         | 21           | Ver lista de medicinas pendientes                | Como Desarrollador, Quiero conectar el componente elder-reminders al API service, Para que se vean medicinas pendientes.                     | 2                   | Rafael      | To-do          |
| 120           | Ver signos vitales de adultos mayores                     | 22           | Ver signos vitales de adultos mayores            | Como Desarrollador, Quiero conectar el componente elder-vital-signs al API service, Para que los usuarios visualicen signos vitales.         | 3                   | Erick       | To-do          |
| 121           | Soporte técnico                                           | 23           | Soporte técnico                                   | Como Desarrollador, Quiero conectar el componente technical-support al API service, Para que los usuarios reporten problemas.                | 2                   | Oscar       | To-do          |
| 122           | Listar médicos                                            | 24           | Listar médicos                                   | Como Desarrollador, Quiero conectar el componente doctors al API service, Para que los usuarios vean médicos disponibles.                   | 3                   | Fabricio    | To-do          |
| 123           | Ver listado de preguntas                                  | 25           | Ver listado de preguntas                         | Como Desarrollador, Quiero conectar el componente technical-support al API service, Para visualizar preguntas frecuentes.                    | 2                   | Adriana     | To-do          |
| 124           | Visualización signos vitales pacientes post operatorios   | 26           | Visualización signos vitales pacientes post operatorios | Como Desarrollador, Quiero crear una pantalla para signos vitales de post operatorios, Para monitorear en tiempo real.                     | 2                   | Fabio       | To-do          |
| 125           | Visualización signos vitales pacientes en UCI             | 27           | Visualización signos vitales pacientes en UCI    | Como Desarrollador, Quiero crear una pantalla para signos vitales en UCI, Para monitorear en tiempo real.                                    | 2                   | Rafael      | To-do          |
